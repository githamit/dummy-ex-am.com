...
<head>
    ...
    <link href="{{asset('superadmin_asset/vendor/fontawesome-free/css/all.min.css')}}" rel="stylesheet" type="text/css">
    <link
        href="https://fonts.googleapis.com/css?family=Nunito:200,200i,300,300i,400,400i,600,600i,700,700i,800,800i,900,900i"
        rel="stylesheet">

    <!-- Custom styles for this template-->
    <link href="{{asset('superadmin_asset/css/sb-admin-2.min.css')}}" rel="stylesheet">
    ...
    <div id="wrapper">
        ...
        <div><img src="{{asset('web_assets/images/bc_images/1vivahlogoa.jpg')}}" style="height:73px; width:255px;"></img></div>
            ...
            <li class="nav-item">
                <a class="nav-link" href="">
                <i class="fas fa-fw fa-table"></i>
                <span>Marital Status Table</span></a>
            </li>

             <li class="nav-item">
                <a class="nav-link" href="">
                <i class="fas fa-fw fa-table"></i>
                <span>States Table</span></a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link" href="">
                <i class="fas fa-fw fa-table"></i>
                <span>Bride Registration</span></a>
            </li>

            <li class="nav-item">
                <a class="nav-link" href="">
                <i class="fas fa-fw fa-table"></i>
                <span>Groom Registration</span></a>
            </li>
