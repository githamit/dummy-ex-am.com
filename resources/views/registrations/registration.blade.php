                    ...
                    <div style="width:256px; border-radius:20px;border-style:groove; border-block-color: red; height:989px;">
                        ...
                        <form action="{{route('registration')}}" method="post" class="p-3 mt-3">
                          ...
                          <!--     <div class="form-field d-flex align-items-center"> <span class="far fa-user"></span> <input type="text" name="email_mobile_no" class="form-control email_mobile_no"placeholder="Email / Mobile No"> </div> -->
                            ...
                            <div class="form-field d-flex align-items-center"> <label class="form-control-label text-muted">Last Name</label><input type="text" name="last_name" id="last_name"  class="form-control"placeholder="Last Name" required="" > 
                            </div>

                             <div class="form-field d-flex align-items-center"> <label class="form-control-label text-muted">Mobile No</label><input type="number" name="mobile_no" id="mobile_no"  class="form-control"placeholder="Mobile No" required="" > 
                              <p class="alert_msg"></p>
                             </div>

<!-- 
                            <div class="form-field d-flex align-items-center"> <label class="form-control-label text-muted">Email</label> <input type="email" name="email" id="to"  class="form-control"placeholder="Enter Email">
                            </div> -->


                      <!--       <p id="confirmMsg"></p>
                            <p id="otp_msg"></p> -->
                          <div class="form-field d-flex align-items-center"><label class="form-control-label text-muted">Email</label> <input type="text" name="email" class="form-control " id="email"  placeholder="Email"> </div>
                           ...
                           <div class="form-field d-flex align-items-center"> <label class="form-control-label text-muted">Otp</label> <input type="text" name="otp" class="form-control mail_otp" placeholder="Enter Otp"> 
                           </div>
                           <p id="confirm_otp"></p>
                            <input type="hidden"  name="" id="setMailOtp" placeholder="hidden Mail Otp">
            ...
            <div class="col-sm-6">
                ...
                <!-- <button type="submit" name="submit" class="btn mt-3" style="background-color: #931111; width:221px; margin-top:20px; margin-left: 20px;"><a href="{{route('login')}}">Alredy have an account?in One Vivah</a></button> -->
                <a href="{{route('login')}}">Alredy have an account?in One Vivah</a>
...
<script type="text/javascript">
  $(document).ready(function(){
      ...
      $("#email").keyup(function(){
        ...
        //START -Check if email id is valid
        if (confEmail == '') {
            $("#isEmailValid").html('Email id can not be empty').css("color","Tomato");
            return false;
        }

        if (IsEmail(confEmail) == false) {
            $("#isEmailValid").html('Email id is not valid. please add valid email').css("color","Tomato");
            return false;
        }
        ...
        $("#isEmailValid").hide();
//END -Check if email id is valid
...
// ================================================
        ...
        $.ajax({
            ...
            success:function(res){
              ...
              // var resData = json.parse(res);
              var resData = JSON.parse(res);
              // console.log('responce data',resData.mail_otp);
              var status = (resData.status);
              $("#setMailOtp").val(resData.mail_otp);
              if(status==1){
                $("#confirmMsg").html('Email Already Taken ').css("color","red");
              }else{
                $("#otp_msg").html(' Check Your Otp In Email!').css("color","Tomato");
        ...
        console.log(setMailOtp);
          if(mail_otp == setMailOtp){
            $("#confirm_otp").hide();
             ...
             $("#confirm_otp").html('Fill Your otp').css("color","red");
          }
